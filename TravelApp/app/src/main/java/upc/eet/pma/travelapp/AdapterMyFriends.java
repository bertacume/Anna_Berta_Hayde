...
public class AdapterMyFriends extends BaseAdapter implements Filterable {
    protected Activity activity;
    protected ArrayList<UserChild> items;
    CustomFilter filter;
    ArrayList<UserChild> filterList;

    public AdapterMyFriends(Activity activity, ArrayList<UserChild> items) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            v = inf.inflate(R.layout.item_myfriends, null);
        }
